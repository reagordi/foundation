...
use Reagordi\Contracts\Exceptions\UnknownPropertyException;
use Reagordi\Contracts\Exceptions\UnknownMethodException;
use Reagordi\Contracts\Exceptions\InvalidCallException;
...
abstract class BaseObject
{
    ...
    {
        return $this->hasMethod('get' . $name) || $checkVars && property_exists($this, $name);
    }
    ...
    {
        return $this->hasMethod('set' . $name) || $checkVars && property_exists($this, $name);
    }
